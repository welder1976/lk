...
<title>Игровой сервер <?php echo "$titleproject"; ?> - Статистика</title>
...
$sql = "SELECT * FROM characters ORDER BY `totalKills` DESC LIMIT 25";
...
echo "
				...
				<td>$row[name]</td>
				<td>$row[level]</td>
				<td><img src='style/magicstorm/images/icon/$row[race]-$row[gender].gif' alt = 'race'/></td>
				<td><img src='style/magicstorm/images/icon/$row[class].gif' alt = 'class'/></td>
				<td>$row[todayKills]</td>
